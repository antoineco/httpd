...
* `2.4.26-centos`, `2.4-centos`, `2-centos`, `centos` [(2.4/centos/Dockerfile)](https://github.com/antoineco/httpd/blob/4cbd0939ab8778b62c860fc4606443665df5ca12/2.4/centos/Dockerfile)
