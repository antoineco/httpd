...
* `2.4.27-centos`, `2.4-centos`, `2-centos`, `centos` [(2.4/centos/Dockerfile)](https://github.com/antoineco/httpd/blob/f04b3129609bfc2a11f32ffb82be57b3eae2e422/2.4/centos/Dockerfile)
